      ...
      <div className=" text-black bg-[#F1F6FF] font-space-grotesk font-Open-sans ">
        <div className={`${props.margin} `}>
          <div className=" justify-center  flex ">
            <p className="text-center font-bold border-0 rounded-full bg-[#9BBFF01A] px-[19px] py-[6px]">
              {props.main}
            </p>
          </div>
          ...
          <div className="flex justify-center">
            <p className="text-[18px] px-auto flex lg:w-[699px] text-center md:pb-0 pb-[60px]">
              {props.text}
            </p>
          </div>

          <div
            className={`flex ${props.style} flex-col items-center container mx-auto`}
          >
